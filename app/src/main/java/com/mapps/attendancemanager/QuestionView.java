...
public class QuestionView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Typeface customFont = Typeface.createFromAsset(this.getAssets(),"fonts/medium.ttf");
        Typeface customFont2 = Typeface.createFromAsset(this.getAssets(),"fonts/regular.ttf");

        Subject.setTypeface(customFont);
